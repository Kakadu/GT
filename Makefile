...
PLUGINS=show gmap compare eq foldl foldr eval stateful fmt html #show_typed #htmlTy
add_plugins:
	$(eval OBPARAMS  += -I common)
...
REGRES_CASES += 030 031 032 037 041 #005
#mutual cases
REGRES_CASES += #003 013 014 082 089
REGRES_CASES += 024 025 036 021 040
REGRES_CASES += 081 083 086 087 090
# PPX based tests
REGRES_CASES += 814 803 804 805 806 810 811 812 820 821 822 809 #808
#mutual cases
REGRES_CASES += #801
